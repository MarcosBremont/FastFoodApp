    ...
    public class AndroidNotificationManager
    {
        ...
        public int CrearNotificacionLocal(string pTitle, string pBody)
        {
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(AndroidApp.Context, channelId)
                ...
                .SetAutoCancel(true)
                .SetLargeIcon(BitmapFactory.DecodeResource(AndroidApp.Context.Resources, Resource.Drawable.Lets_Eat_Again_Logo))
                .SetSmallIcon(Resource.Drawable.Lets_Eat_Again_Logo)
